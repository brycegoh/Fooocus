...
path_segmentation = get_dir_or_set_default('path_segmentation', '../models/segmentation/')
...
def downloading_controlnet_depth():
    ...
    return os.path.join(path_controlnet, 'control-lora-depth-rank128.safetensors')
