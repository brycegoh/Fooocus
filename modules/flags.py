...
ip_list = [cn_ip, cn_canny, cn_cpds, cn_depth, cn_ip_face]
default_ip = cn_ip

default_parameters = {
    cn_ip: (0.0, 0.5, 0.6), cn_ip_face: (0.0, 0.9, 0.75), cn_canny: (0.0, 0.5, 1.0), cn_depth: (0.0, 0.5, 1.0),cn_cpds: (0.0, 0.5, 1.0)
}  # stop, weight
