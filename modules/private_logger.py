...
def pil_to_base64(image, output_format='PNG'):
    buffered = io.BytesIO()
    image.save(buffered, format=output_format)  # Change the format as per your image type
    return base64.b64encode(buffered.getvalue()).decode('utf-8')

def log(img, output_format=None) -> str:
    ...
    image_b64 = pil_to_base64(Image.fromarray(img), output_format.upper())
